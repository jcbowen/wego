...
const (
	...
	// 模板消息
	APISendTemplateMsgURL  = "https://api.weixin.qq.com/cgi-bin/message/template/send"
	APIAddTemplateURL      = "https://api.weixin.qq.com/cgi-bin/template/api_add_template"
	APIQueryBlockTmplMsgURL = "https://api.weixin.qq.com/cgi-bin/template/get_industry"
	APIDeleteTemplateURL   = "https://api.weixin.qq.com/cgi-bin/template/del_private_template"
	APIGetAllTemplatesURL  = "https://api.weixin.qq.com/cgi-bin/template/get_all_private_template"
	APIGetIndustryURL      = "https://api.weixin.qq.com/cgi-bin/template/get_industry"
	APISetIndustryURL      = "https://api.weixin.qq.com/cgi-bin/template/api_set_industry"

	// 客服消息
	APISendCustomMsgURL    = "https://api.weixin.qq.com/cgi-bin/message/custom/send"
