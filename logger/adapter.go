...
// @param msg 日志消息
// @param fields 附加字段
func (a *DebuggerLoggerAdapter) Debug(msg any, fields ...map[string]interface{}) {
	a.debuggerLogger.Debug(msg, fields...)
}
...
// @return string 日志级别
func (a *DebuggerLoggerAdapter) GetLevel() string {
...
func (a *wegoLoggerToDebuggerAdapter) Debug(msg any, fields ...map[string]interface{}) {
	a.wegoLogger.Debug(msg, fields...)
}
...
func (a *wegoLoggerToDebuggerAdapter) GetLevel() string {
